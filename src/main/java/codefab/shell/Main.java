...
public final class Main {
    ...
    private static Mode select(String[] args) {
        ...
        if (first.equals("explain")) {
            return args.length == 2 ? new ExplainMode(args[1]) : null;
        }
    ...
    private static void printUsage(PrintStream out) {
        ...
        out.println("  factory explain <file>        Show scanner/parser/checker/folding/executor pipeline output");
